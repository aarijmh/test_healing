...
public class WidgetLocator
{
	...
	private static String[] OLD_WEB_SITES = {"http://localhost:8080","https://web.archive.org/web/20180702000525if_/https://www.adobe.com/", "https://web.archive.org/web/20170401212838if_/https://www.aliexpress.com/", "https://web.archive.org/web/20170402if_/http://www.amazon.com/",
	...
	private static String[] NEW_WEB_SITES = {"http://localhost:8080/modified","https://web.archive.org/web/20201102003024if_/https://www.adobe.com/", "https://web.archive.org/web/20201201235538if_/https://www.aliexpress.com/", "https://web.archive.org/web/20201201if_/https://www.amazon.com/",
			...
			try
			{
				...
				for(Locator targetLocator:targetLocators)
				{
					...
					else
					{
						...
						{
							System.out.println("Element Found : "+bestCandidateXPath);
							located++;
						}
						else
						{
